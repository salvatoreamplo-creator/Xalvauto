...
import salvoamplo.xalvautobe.entities.Carburante;
...
public class AutoController {
    ...
    public Auto createAuto(
            ...
            @RequestParam("carburante") Carburante carburante,
    ...
    public Auto updateAuto(@PathVariable Long id, @RequestBody Auto updatedAuto) {
        ...
        found.setCilindrata(updatedAuto.getCilindrata());
        found.setCarburante(updatedAuto.getCarburante());
